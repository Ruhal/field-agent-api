...
public class LocationController {
    ...
    @PostMapping
    public ResponseEntity<Object> add(@RequestBody(required = false) Location location) {
    ...
    public ResponseEntity<Object> update(@PathVariable int locationId, @RequestBody(required = false) Location location) {
