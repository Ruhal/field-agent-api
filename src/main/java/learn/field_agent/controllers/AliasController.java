...
public class AliasController {
    ...
    public List<Alias> findByAgentId(@PathVariable int agentId) {
    ...
    @PutMapping("/{aliasId}")
    public ResponseEntity<Object> update(@PathVariable int aliasId, @RequestBody(required = false) Alias alias) {
