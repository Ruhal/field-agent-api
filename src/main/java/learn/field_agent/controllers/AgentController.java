...
public class AgentController {
    ...
    @PostMapping
    public ResponseEntity<Object> add(@RequestBody(required = false) Agent agent) {
    ...
    @PutMapping("/{agentId}")
    public ResponseEntity<Object> update(@PathVariable int agentId, @RequestBody(required = false) Agent agent) {
