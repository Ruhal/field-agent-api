...
public class AgencyAgentController {
    ...
    @PostMapping
    public ResponseEntity<Object> add(@RequestBody(required = false) AgencyAgent agencyAgent) {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody(required = false) AgencyAgent agencyAgent) {
